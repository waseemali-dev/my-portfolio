...
export const DEFAULT_PORTFOLIO_CONTENT = {
  hero: {
    ...
    headline: "Front-End & HubSpot CMS Developer Building Fast, and Responsive Websites",
    description: "I build clean, responsive, and high-performing websites using HubSpot CMS, WordPress, and modern front-end technologies.",
    ctaText: "Hire Me Now",
    ctaLink: "#contact",
