export const SAVED_PORTFOLIO_CONTENT = {
  ...
  "projects": [
    {
      ...
      "imageUrl": "boston-institute-finance",
      "featured": true
    },
    {
    ...
    },
    {
      ...
      "imageUrl": "aptitude-learning-hub",
      "featured": false
    },
    {
    ...
    },
    {
      ...
      "imageUrl": "saas-landing-platform",
      "featured": false
    },
    {
      ...
      "imageUrl": "realestate-directory-wp",
      "featured": false
    },
    {
  ...
  "faqs": [
    ...
    },
    {
      ...
      "answer": "Yes. I offer performance optimization services. I audit websites using Google PageSpeed Insights, Lighthouse, and GTmetrix, then fix speed issues by minifying assets, lazy-loading media, removing redundant scripts, implementing caching, and structuring layouts to eliminate CLS."
    },
    {
      "question": "Do you work with WordPress?",
      "answer": "Yes. I develop highly customized, responsive WordPress websites. I build lightweight themes, custom blocks powered by Advanced Custom Fields (ACF), and optimize WooCommerce setups, avoiding heavy builders that bloat speed."
    },
    {
      "question": "Are you available for freelance projects?",
      "answer": "Yes, I am actively open for freelance and contract opportunities. I partner with design agencies, marketing firms, startups, and established enterprises on platforms like LinkedIn, Upwork, and Fiverr."
    }
  ],
  "contact": {
    "badge": "Let's Connect",
